...
best_model = load_model('best_epoch_resnet_10User.h5', custom_objects={'top3_acc': top3_acc})
...
def plot_confusion_matrix(cm, classes,
    ...
    fig.savefig('cm_best_10_10User.png')
...
plot_confusion_matrix(cm, cm_plot_labels, title = 'Confusion Matrix 10 Users')